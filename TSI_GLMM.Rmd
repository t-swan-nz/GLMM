...
albo_poisson_R2 <- r.squaredGLMM(albo_poisson)
...
#the binomial model has the lowest AIC weights, but the highest residuals (most overdispersed). None of the models do a great job at predicting the proportion of variance explained by the model as a whole (low R2) for "R2c".
